...
export function CoolThemeToggle({ className, size = "md" }: CoolThemeToggleProps) {
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
      className={cn(
        "relative rounded-full transition-colors duration-500 ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 overflow-hidden cursor-pointer shrink-0",
    ...
    >
      ...
      <motion.div
        ...
        animate={{
          x: theme === "dark" ? currentSize.translateX : 0,
        }}
      >
